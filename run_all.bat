...
start "Backend" /D "%APP_DIR%" cmd /k ""%VENV_PY%" -m uvicorn backend.main:app --reload --port 8000"

echo Dang mo frontend...
start "Frontend" /D "%APP_DIR%" cmd /k ""%VENV_PY%" -m streamlit run frontend/app.py"
